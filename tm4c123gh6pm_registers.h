...
GPTM Registers
*****************************************************************************/
#define TIMER0_GPTMCFG             (*((volatile uint32 *)0x40030000))
#define TIMER0_GPTMTAMR            (*((volatile uint32 *)0x40030004))
#define TIMER0_GPTMTBMR            (*((volatile uint32 *)0x40030008))
#define TIMER0_GPTMCTL             (*((volatile uint32 *)0x4003000C))
#define TIMER0_GPTMIMR             (*((volatile uint32 *)0x40030018))
#define TIMER0_GPTMRIS             (*((volatile uint32 *)0x4003001C))
#define TIMER0_GPTMICR             (*((volatile uint32 *)0x40030024))
#define TIMER0_GPTMTAILR           (*((volatile uint32 *)0x40030028))
#define TIMER0_GPTMTBILR           (*((volatile uint32 *)0x4003002C))
#define TIMER0_GPTMTAMATCHR        (*((volatile uint32 *)0x40030030))
#define TIMER0_GPTMTBMATCHR        (*((volatile uint32 *)0x40030034))
